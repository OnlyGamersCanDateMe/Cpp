    ...
    do
    {
        ...
        switch (ch) {
            ...
            case 2: displayData();      //read data from file stu.txt
                break;
            case 3: deleteData();       //delete data from file stu.txt
                break;
...
void Student::getData()                 //will get data from the console
{
    cout << "\n\n**********Enter Student Data**********\n";
    ...
    spercentage = smarks * 100.0 / 500.0;
...
void addData()
{
    ...
    fout.open("Stu.txt", ios::out | ios::app | ios::binary);// open file in output,append and binary mode
